...
<!-- Card Wider -->
                ...
                <!-- Blog Post -->
                <div class="card mb-4">
                  <img class="card-img-top" src="img/Exclusive_Funko_Pop_Vinyl-012818.jpg" alt="Card image cap">
                  <div class="card-body">
                    <h2 class="card-title">POPS EXCLUSIVES!</h2>
                    <p class="card-text">Pour une plus grosse collection ou d'avantage de mise en scène : https://www.popinabox.fr/ Découvre les dernières figurines Pop! exclusives et édition limitées! On en a pour toutes les collections! </p>
                    <a href="#" class="btn btn-primary">Partage &rarr;</a>
                  </div>
